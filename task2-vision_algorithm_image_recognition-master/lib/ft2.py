...
# tools                                          #
#------------------------------------------------#
# draw chinese text using freetype on python3.x  #                  #
# 2020.02.29                                     #
##################################################
'''
...
ft = put_chinese_text('/usr/share/fonts/truetype/wqy/wqy-microhei.ttc')
...
#     ft = put_chinese_text('/usr/local/Qt-5.12/lib/fonts/wqy-microhei.ttc') # C:/WINDOWS/Fonts/SIMYOU.TTF
